      ...
      <div className="container relative z-10 px-4 sm:px-6 text-center">
        ...
        >
          ...
          <Button
            size="lg"
            variant="outline"
            className="group relative overflow-hidden px-12 py-5 rounded-full border-4 bg-gradient-to-r from-blue-100 via-white to-green-100 border-transparent text-blue-700 text-xl font-bold shadow-xl hover:bg-gradient-to-r hover:from-blue-200 hover:via-white hover:to-green-200 hover:text-blue-900 hover:scale-110 hover:shadow-2xl transition-all duration-200"
            asChild
          >
            <Link href="/#seo-audit" className="flex items-center text-xl">
              Free SEO Audit
