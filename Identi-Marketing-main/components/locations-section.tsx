...
export function LocationsSection() {
  ...
  return (
    <section id="locations" className="py-16 sm:py-24 relative overflow-hidden bg-gradient-to-b from-background to-background/90">
      ...
      <div className="container relative z-10 px-4 sm:px-6">
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div 
                  ...
                  className="group relative overflow-hidden bg-background/70 backdrop-blur-sm border border-white/10 rounded-2xl p-4 sm:p-6 text-center hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 hover:border-white/20"
                  whileHover={{ scale: 1.03 }}
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  
                  <div className="relative z-10">
                    <div className={`flex items-center justify-center w-20 h-20 sm:w-28 sm:h-28 rounded-2xl bg-gradient-to-br ${stat.color} mb-2 mx-auto shadow-lg`}>
                      <AnimatedCounter 
                        value={stat.value} 
                        suffix={stat.suffix} 
                        delay={index * 100}
        ...
        >
          <Tabs defaultValue="uk" className="w-full">
            <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-8 sm:mb-12 p-1.5 bg-muted/30 backdrop-blur-sm border border-white/10 rounded-full overflow-hidden">
              <TabsTrigger 
                value="uk" 
                className="relative text-sm sm:text-base font-medium data-[state=active]:text-white rounded-full z-10 transition-all duration-300 group"
              >
                    ...
                    <CardHeader className="relative z-10 p-6 sm:p-8">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 rounded-lg bg-gradient-to-br from-pink-500/10 to-purple-500/10">
                          <MapPin className="h-5 w-5 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500" />
                        </div>
                        <CardTitle className="text-lg sm:text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/80">
                          Major Cities
                        </CardTitle>
                      </div>
  ...
  {['London', 'Manchester', 'Birmingham', 'Edinburgh', 'Glasgow', 'Stoke-on-Trent', 'Liverpool', 'Leeds', 'Sheffield', 'Bristol', 'Nottingham', 'Leicester'].map((city, i) => (
    <motion.div
      ...
      className="rounded-lg bg-white/70 dark:bg-background/70 px-2 py-1 flex flex-col items-center justify-center relative overflow-hidden"
    >
      ...
      <span className="font-semibold text-xs sm:text-sm text-gray-900 dark:text-white text-center tracking-tight mt-1 mb-0">
        {city}
      </span>
    </motion.div>
  ))}
                    ...
                    <CardHeader className="relative z-10 p-6 sm:p-8">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 rounded-lg bg-gradient-to-br from-blue-500/10 to-cyan-500/10">
                          <Globe className="h-5 w-5 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500" />
                        </div>
                        <CardTitle className="text-lg sm:text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/80">
                          Coverage Map
                        </CardTitle>
