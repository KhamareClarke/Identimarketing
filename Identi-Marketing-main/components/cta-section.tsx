            ...
            <CardContent className="flex justify-center pb-6 sm:pb-8 relative z-10 px-4 sm:px-6 md:px-8">
              ...
              >
                ...
                <div className="mt-6 z-20 relative">
                  <form className="flex flex-col sm:flex-row items-center gap-3" action="/api/newsletter" method="POST">
                    <input
                      type="email"
                      name="email"
                      required
                      className="px-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:border-primary text-base w-full sm:w-auto"
                      placeholder="Enter your email for marketing tips"
                      aria-label="Email address"
                    />
                    <Button type="submit" size="lg" className="group relative overflow-hidden px-12 py-5 rounded-full bg-gradient-to-r from-pink-500 via-blue-500 to-green-400 text-white text-xl font-extrabold shadow-2xl hover:from-blue-600 hover:via-pink-500 hover:to-green-400 hover:scale-110 hover:shadow-3xl transition-all duration-200 border-0 focus:ring-4 focus:ring-blue-300">
