    ...
    <section id="pricing" className="relative py-20 sm:py-28 bg-gradient-to-b from-background to-background/90 overflow-hidden">
      ...
      <div className="container relative z-10 px-4">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 p-3 rounded-full bg-white/70 dark:bg-background/60 shadow-xl backdrop-blur-md border border-gradient-to-r from-pink-500 via-blue-500 to-green-400 mb-2">
            {offers.map((offer) => (
              <button
                key={offer.value}
