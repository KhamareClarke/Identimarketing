...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-16 sm:py-20 bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
      {/* Background elements */}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="bg-gray-100 dark:bg-gray-800 p-4 sm:p-6 rounded-lg">
            ...
            <motion.div 
              className="lg:col-span-3 bg-white dark:bg-gray-800 rounded-3xl p-6 sm:p-10 border-0 shadow-2xl dark:shadow-gray-900/50 relative overflow-hidden"
              variants={containerVariants}
              initial="hidden"
              animate={inView ? "visible" : "hidden"}
            >
                ...
                <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-1 sm:space-y-2">
                    ...
                    <Input
                      ...
                      className="h-12 rounded-xl border-2 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 text-base bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 px-4 transition-all duration-200 outline-none"
                    />
                  </div>
                  <div className="space-y-1 sm:space-y-2">
